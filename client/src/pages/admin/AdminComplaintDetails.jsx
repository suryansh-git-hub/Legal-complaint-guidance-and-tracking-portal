        ...
        <aside>
          ...
          <section className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm lg:sticky lg:top-6">
            <div className="flex items-center gap-3 border-b border-gray-200 pb-4">
              ...
              <div>
                <h2 className="font-semibold text-gray-900">Manage Complaint</h2>
                <p className="mt-1 text-xs text-gray-500">Update status and remarks.</p>
              </div>
            </div>
            ...
            <form onSubmit={handleUpdate} className="mt-5 space-y-5">
              <div>
                ...
                <select
                  ...
                  className="mt-2 w-full rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-sm text-gray-700 outline-none transition focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
                >
                  <option value={complaint.status}>{formatStatus(complaint.status)}</option>
                  {nextStatus && <option value={nextStatus}>{formatStatus(nextStatus)}</option>}
                </select>
              </div>
              ...
              <div>
                ...
                <p className="mt-1 text-xs text-gray-500">These remarks will be visible to the user.</p>
                ...
                <p className="mt-1 text-right text-xs text-gray-400">{adminRemarks.length}/1000</p>
              </div>
